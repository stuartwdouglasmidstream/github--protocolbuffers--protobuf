...
export PROJECT_VERSION=3.23.2
export JAVA_HOME=/lib/jvm/java-1.7.0
export ENFORCE_VERSION=

set -- "$@" install -DallowIncompleteProjects -Danimal.sniffer.skip -Dcheckstyle.skip -Dcobertura.skip -Denforcer.skip -Dformatter.skip -Dgpg.skip -Dimpsort.skip -Djapicmp.skip -Dmaven.javadoc.failOnError=false -Dmaven.site.deploy.skip -Dpgpverify.skip -Drat.skip=true -Drevapi.skip -Dsort.skip -Dspotbugs.skip -DskipTests -Prelease -f java/pom.xml org.apache.maven.plugins:maven-deploy-plugin:3.0.0-M2:deploy 
